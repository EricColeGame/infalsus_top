...
export default function PrivacyPolicyPage() {
  return (
    <LegalPage title="Privacy Policy">
      <p>This fan wiki provides informational game guides for In Falsus. We do not request account credentials, Steam credentials or passwords, or private payment information.</p>
